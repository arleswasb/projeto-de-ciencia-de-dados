...
def load_and_preprocess_data():
    ...
    try:
        ...
        # Se for 'df_teste.csv', mude a linha abaixo.
        df = pd.read_csv('DB_completo_plataformas.csv')
        # df = pd.read_csv('df_teste.csv') # Use esta linha se o arquivo for df_teste.csv
    except FileNotFoundError:
        st.error("ERRO: O arquivo CSV ('DB_completo_plataformas.csv' ou 'df_teste.csv') não encontrado. Por favor, certifique-se de que o arquivo está na mesma pasta do script.")
        st.stop()
    ...
    # NÃO EXPLODIR AQUI! A explosão será feita APÓS a filtragem.
