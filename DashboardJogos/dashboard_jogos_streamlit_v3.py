...
st.set_page_config(layout="wide", page_title="Dashboard de Análise de Jogos (Filtros Globais Parciais)")

st.title("🎮 Dashboard de Análise de Jogos com Plotly (Filtros Seletivos)")
...
selected_platforms_global = st.sidebar.multiselect(
    ...
    key='global_platforms' # Adicionando key para unicidade
)
...
selected_genres_global = st.sidebar.multiselect(
    ...
    key='global_genres' # Adicionando key para unicidade
)
