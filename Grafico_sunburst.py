...
try:
    ...
    df_sunburst = df.melt(
        ...
        value_vars=genre_columns, # Agora 'genre_columns' está definida
        var_name='genre_full',
        value_name='is_genre'
    )
    ...
    print(f"Erro: Coluna não encontrada para o gráfico Sunburst: {e}. Verifique 'release_year', 'platform', e as colunas 'genre_'.")
except Exception as e:
    print(f"Erro ao gerar o gráfico Sunburst: {e}")