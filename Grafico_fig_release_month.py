...
try:
    ...
    print("Erro: A coluna 'release_month' não foi encontrada no DataFrame. Verifique os nomes das colunas.")
except Exception as e:
    print(f"Erro ao gerar o gráfico de contagem de jogos por mês de lançamento: {e}")